...
We can see the class of the cancer_sample data is data frame with various tibbles variations. It has 569 rows and 32 columns. We can also see all the column name. 

```{r}
class(flow_sample)
glimpse(flow_sample)
```
We can see the class of the flow_sample data is data frame and tibble. It has 218 rows and 7 columns. We can also see all the column name.
...
We can see the class of the apt_buildings data is data frame and tibble. It has 3455 rows and 37 columns. We can also see all the column name.

```{r}
class(building_permits)
glimpse(building_permits)
```
We can see the class of the building_permits data is data frame with various tibbles variations. It has 20680 rows and 14 columns. We can also see all the column name. 
...
Cancer_sample, since it has a relatively small row entires and I do want to pursue in biostatistics in the near future, so it's a good practice to analyze medical data. <!----------------------------------------------------------------------------->
...
I want to explore the relationship between diagnosis and other variables. Specifically which explantory variables will have an effect on diagnosis. 
...
<!--- *****START HERE***** --->
1. Does radius_mean and area_mean influence the diagnosis result?
2. Is there interaction between radius_mean and perimeter_mean?
3. Which explanatory variable(every variables beside diagnosis) is the most statistical significance?
4. Is there a positive or negative correlation between diagnosis and radius_mean?
<!----------------------------->
